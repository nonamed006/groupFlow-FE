...
const emp = {
    ...
    */
    getEmpList: (srhCorp, srhWorkType, srhNm) => {
        ...
        if (srhWorkType !== "" && srhWorkType !== undefined && srhWorkType !== 'undefined') 
        ...
        const promise = getPromise({ url: `emp/getEmp?${paramString}`, method: 'GET' });
    ...
    */
    deleteEmp: (empCd) => {
        const promise = getPromise({ url: `emp/deleteEmp/${empCd}`, method: 'GET' });
        return promise.then((responseJson) => responseJson);
    },
